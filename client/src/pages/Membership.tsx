        ...
        <div className="max-w-2xl mx-auto bg-gray-50 p-8 rounded-lg shadow-inner">
          ...
          <form>
            <div className="mb-4 text-right">
              ...
              <input type="text" id="name" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required />
            </div>
            <div className="mb-4 text-right">
              <label htmlFor="email" className="block text-gray-700 font-semibold mb-2">البريد الإلكتروني</label>
              <input type="email" id="email" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required />
            </div>
            <div className="mb-4 text-right">
              <label htmlFor="country" className="block text-gray-700 font-semibold mb-2">الدولة المقيم بها</label>
              <input type="text" id="country" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required />
            </div>
            <div className="mb-6 text-right">
              <label htmlFor="whatsapp" className="block text-gray-700 font-semibold mb-2">رقم الواتس اب (مع رمز الدولة)</label>
              <input type="tel" id="whatsapp" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required />
            </div>
